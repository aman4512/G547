...
Using GNU toolchain for AVR microcontrollers installed, run "make" in the sub-directory "firmware".This project requires avr-gcc and avr-libc. 
To set the fuse-bits to use the external crystal:
